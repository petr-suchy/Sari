...
/*
    ...
    enabling type erasureand polymorphic behavior. This is particularly useful when you want to store functions
    with different types of arguments in the same container.
*/
